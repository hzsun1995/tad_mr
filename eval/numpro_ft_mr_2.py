...
def video_demo(model, video_info, data_path, num_sampled_frames, input_format, instruction, position="bottom_right", font_size=40, color="red", temp_dir="temp"):
    ...
    if match:
        response["pred_start"] = int(match.group(1)) * 2
        response["pred_end"] = int(match.group(2)) * 2
...
if __name__ == "__main__":
    ...
    LORA_PATH="checkpoints/longva_7b_dpo_FT"
    ...
    parser.add_argument("--save_path", type=str, default="results/charades_numpro_ft_100.json")
