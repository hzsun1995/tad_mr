...
# qvhighlights 数据集 - moment retrieval任务
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="/media/junhuan/f735e2d6-fcde-4053-9be9-15ec61577e6e1/data/qv_videos/")

    parser.add_argument("--save_path", type=str, default="results/qvhighlights_numpro_ft.json")
    parser.add_argument("--test_path", type=str, default="/home/sunhaozhou/NumPro/data/qv_new.json") # 不存在
    ...
    parser.add_argument("--lora_path", type=str, default="checkpoints/longva_7b_dpo_NumPro_FT")
