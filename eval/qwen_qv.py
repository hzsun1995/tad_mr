...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="data/qv_new.json", help="Path to the input JSON file containing video queries.")
    parser.add_argument("--save_path", type=str, default="results/0102_qwen_qv.json", help="Path to save the output JSON file with responses.")
    
    parser.add_argument("--video_path", type=str, default="/media/junhuan/f735e2d6-fcde-4053-9be9-15ec61577e6e1/data/qv_videos/", help="Path to the video file.")
