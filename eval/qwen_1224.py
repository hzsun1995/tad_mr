...
# qwen_config = Qwen2Config(use_flash_attn=True)

model = Qwen2VLForConditionalGeneration.from_pretrained(
    "/media/junhuan/f735e2d6-fcde-4053-9be9-15ec61577e6e1/models/qwen2-vl-int4",
    config="/media/junhuan/f735e2d6-fcde-4053-9be9-15ec61577e6e1/models/qwen2-vl-int4/config.json",  # 使用启用 FlashAttention 的配置
    torch_dtype="auto",
...
def process_video_queries(model, processor, data_path, save_path, input_format, instruction, device, video_path=None, position='top_right', font_size=80, color='red'):
...
if __name__ == "__main__":
    ...
    process_video_queries(model, processor, args.data_path, args.save_path, args.input_format, args.instruction, device, args.video_path, args.position, args.font_size, args.color)